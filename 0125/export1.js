...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_show_me_the_answer')) {
        Object.defineProperty(Module['ready'], '_show_me_the_answer', { configurable: true, get: function() { abort('You are getting _show_me_the_answer on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_show_me_the_answer', { configurable: true, set: function() { abort('You are setting _show_me_the_answer on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
